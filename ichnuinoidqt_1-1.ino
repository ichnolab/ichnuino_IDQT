 ...
 //TestingEngineDB(rev_2.2)
 //(real cd/m2 readings,db built on over 150 parts tested)
 
 //color temp levels (Kelvin)
 int kMin = 8500;  
 int kBad = 7500;        
 int kAvg = 7000;
 int kGud = 6500;
 ...
 void setup(void)
{
 ...
 display.println(F("sw=1.1            hw=1.1"));
 display.setTextSize(1);             
 display.setTextColor(WHITE);       
